...
CREATE USER IF NOT EXISTS F1_CICD_USER
  ...
  COMMENT = 'F1 project: USER for CICD workloads';

-- Grant the custom role to the new user
GRANT ROLE F1_CICD_ROLE TO USER F1_CICD_USER;
GRANT ROLE ACCOUNTADMIN TO USER F1_CICD_USER; --JUST FOR EXTERNAL ACCESS INTEGRATION CREATION
GRANT ROLE SYSADMIN TO USER F1_CICD_USER;
